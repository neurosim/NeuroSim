...
Please set technode, memory, tputype and model

TPU memory access count tables (traces) are from Timeloop and are provided directly
There are 3 avaible traces currently: model=VGG8, tputype=edge; model=VGG8, tputype=cloud; model=ResNet18, tputype=edge
